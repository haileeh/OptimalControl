...
function output = debrisPickupEndpointADiGatorGrd(input)
global ADiGator_debrisPickupEndpointADiGatorGrd
if isempty(ADiGator_debrisPickupEndpointADiGatorGrd); ADiGator_LoadData(); end
Gator1Data = ADiGator_debrisPickupEndpointADiGatorGrd.debrisPickupEndpointADiGatorGrd.Gator1Data;
...
cada1td1 = zeros(2,1);
cada1td1(1) = a1.dv;
cada1td1(2) = cada1td1(2) + a2.dv;
cada1f1dv = cada1td1;
cada1f1 = a1.f + a2.f;
cada1td1 = zeros(3,1);
cada1td1(Gator1Data.Index1) = cada1f1dv;
cada1td1(3) = cada1td1(3) + a3.dv;
a.dv = cada1td1;
a.f = cada1f1 + a3.f;
%User Line: a = a1+a2+a3;
cada1td1 = zeros(2,1);
cada1td1(1) = mf1.dv;
cada1td1(2) = cada1td1(2) + mf2.dv;
cada1f1dv = cada1td1;
cada1f1 = mf1.f + mf2.f;
cada1td1 = zeros(3,1);
cada1td1(Gator1Data.Index2) = cada1f1dv;
cada1td1(3) = cada1td1(3) + mf3.dv;
mf.dv = cada1td1;
mf.f = cada1f1 + mf3.f;
%User Line: mf = mf1+mf2+mf3;
cada1td1 = zeros(6,1);
cada1td1(Gator1Data.Index3) = a.dv;
cada1td1(Gator1Data.Index4) = cada1td1(Gator1Data.Index4) + -mf.dv;
...
cada1td1(Gator1Data.Index10) = cada1td1(Gator1Data.Index10) + -cada1f2dv;
cada1f3dv = cada1td1;
cada1f3 = cada1f1 - cada1f2;
cada1td1 = zeros(2,1);
cada1td1(2) = initialtime2.dv;
cada1td1(1) = cada1td1(1) + -finaltime1.dv;
cada1f4dv = cada1td1;
...
cada1td1(Gator1Data.Index21) = cada1td1(Gator1Data.Index21) + -cada1f2dv;
cada1f3dv = cada1td1;
cada1f3 = cada1f1 - cada1f2;
cada1td1 = zeros(2,1);
cada1td1(2) = initialtime3.dv;
cada1td1(1) = cada1td1(1) + -finaltime2.dv;
cada1f4dv = cada1td1;
...
global ADiGator_debrisPickupEndpointADiGatorGrd
ADiGator_debrisPickupEndpointADiGatorGrd = load('debrisPickupEndpointADiGatorGrd.mat');
return
end